...
{\color{incolor}In [{\color{incolor}1}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k+kn}{as} \PY{n+nn}{np}
        ...
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{1d array}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{v}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{v}\PY{o}{.}\PY{n}{shape}\PY{p}{)}                 \PY{c+c1}{\PYZsh{} print the size of v}
        ...
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{2d array}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{v}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{v}\PY{o}{.}\PY{n}{shape}\PY{p}{)}                 \PY{c+c1}{\PYZsh{} print the size of v, notice the difference}
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k+kn}{as} \PY{n+nn}{np}
        ...
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Access a single element}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{m}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}                        \PY{c+c1}{\PYZsh{} access an element}
        ...
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Modified a single element}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{m}\PY{p}{)}                              \PY{c+c1}{\PYZsh{} this will modify the original array}
        
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Access a subarray}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{m}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{p}{:}\PY{p}{]}\PY{p}{)}                        \PY{c+c1}{\PYZsh{} access a row (to 1d array)}
        \PY{k}{print}\PY{p}{(}\PY{n}{m}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{,} \PY{p}{:}\PY{p}{]}\PY{p}{)}                       \PY{c+c1}{\PYZsh{} access a row (to 2d array)}
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Transpose a subarray}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{m}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{p}{:}\PY{p}{]}\PY{o}{.}\PY{n}{T}\PY{p}{)}                      \PY{c+c1}{\PYZsh{} notice the difference of the dimension of resulting array}
        \PY{k}{print}\PY{p}{(}\PY{n}{m}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{,} \PY{p}{:}\PY{p}{]}\PY{o}{.}\PY{n}{T}\PY{p}{)}                     \PY{c+c1}{\PYZsh{} this will be helpful if you want to transpose it later}
        ...
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{Boolean array indexing}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k+kn}{as} \PY{n+nn}{np}
        ...
        \PY{k}{print}\PY{p}{(}\PY{n}{a} \PY{o}{*} \PY{l+m+mi}{2}\PY{p}{)}                                            \PY{c+c1}{\PYZsh{} scalar multiplication}
        \PY{k}{print}\PY{p}{(}\PY{n}{a} \PY{o}{/} \PY{l+m+mi}{4}\PY{p}{)}                                            \PY{c+c1}{\PYZsh{} scalar division}
        \PY{k}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{round}\PY{p}{(}\PY{n}{a} \PY{o}{/} \PY{l+m+mi}{4}\PY{p}{)}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{power}\PY{p}{(}\PY{n}{a}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{log}\PY{p}{(}\PY{n}{a}\PY{p}{)}\PY{p}{)}
        ...
        \PY{k}{print}\PY{p}{(}\PY{n}{a} \PY{o}{+} \PY{n}{b}\PY{p}{)}                                            \PY{c+c1}{\PYZsh{} elementwise sum}
        \PY{k}{print}\PY{p}{(}\PY{n}{a} \PY{o}{\PYZhy{}} \PY{n}{b}\PY{p}{)}                                            \PY{c+c1}{\PYZsh{} elementwise difference}
        \PY{k}{print}\PY{p}{(}\PY{n}{a} \PY{o}{*} \PY{n}{b}\PY{p}{)}                                            \PY{c+c1}{\PYZsh{} elementwise product}
        \PY{k}{print}\PY{p}{(}\PY{n}{a} \PY{o}{/} \PY{n}{b}\PY{p}{)}                                            \PY{c+c1}{\PYZsh{} elementwise division}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k+kn}{as} \PY{n+nn}{np}
        ...
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{sum of array}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{a}\PY{p}{)}\PY{p}{)}                \PY{c+c1}{\PYZsh{} sum of all array elements}
        \PY{k}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{a}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{)}        \PY{c+c1}{\PYZsh{} sum of each column}
        \PY{k}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{a}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}        \PY{c+c1}{\PYZsh{} sum of each row}
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{mean of array}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{a}\PY{p}{)}\PY{p}{)}               \PY{c+c1}{\PYZsh{} mean of all array elements}
        \PY{k}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{a}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{)}       \PY{c+c1}{\PYZsh{} mean of each column}
        \PY{k}{print}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{a}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}       \PY{c+c1}{\PYZsh{} mean of each row}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k+kn}{as} \PY{n+nn}{np}
        ...
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{matrix\PYZhy{}matrix product}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{a}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{b}\PY{p}{)}\PY{p}{)}                 \PY{c+c1}{\PYZsh{} matrix product}
        \PY{k}{print}\PY{p}{(}\PY{n}{a}\PY{o}{.}\PY{n}{T}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{b}\PY{o}{.}\PY{n}{T}\PY{p}{)}\PY{p}{)}
        
        \PY{n}{x} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}  
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{matrix\PYZhy{}vector product}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{n}{a}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{)}                 \PY{c+c1}{\PYZsh{} matrix / vector product}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}7}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k+kn}{as} \PY{n+nn}{np}
        ...
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Image shape}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{img}\PY{o}{.}\PY{n}{shape}\PY{p}{)}           \PY{c+c1}{\PYZsh{} print image size and color depth}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{} The code for this problem is posted on Piazza. Sign up for the course if you have not. Then find}
        ...
        \PY{k}{def} \PY{n+nf}{piazza}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            ...
            \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Iterative method took \PYZob{}0\PYZcb{} seconds}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{end}\PY{o}{\PYZhy{}}\PY{n}{start}\PY{p}{)}\PY{p}{)}
            \PY{n}{start} \PY{o}{=} \PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
            \PY{n}{image\PYZus{}vectorized} \PY{o}{=} \PY{n}{vectorized}\PY{p}{(}\PY{n}{img}\PY{p}{)} 
            \PY{n}{end} \PY{o}{=} \PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
            \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Vectorized method took \PYZob{}0\PYZcb{} seconds}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{end}\PY{o}{\PYZhy{}}\PY{n}{start}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Iterative method took 0.869366168976 seconds
Vectorized method took 0.00425410270691 seconds
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{} Write your code here. Import the image and define the required funtions.}
        ...
        \PY{k}{def} \PY{n+nf}{mergeChannels}\PY{p}{(}\PY{n}{image1}\PY{p}{,}\PY{n}{image2}\PY{p}{,}\PY{n}{image3}\PY{p}{)}\PY{p}{:}
            ...
            \PY{c+c1}{\PYZsh{} Write your code here}
            \PY{n}{img} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{[}\PY{n+nb}{len}\PY{p}{(}\PY{n}{image1}\PY{p}{)}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{image2}\PY{p}{)}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{]}\PY{p}{)}
            \PY{n}{img}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]} \PY{o}{=} \PY{n}{image1}
            \PY{n}{img}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{p}{:}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]} \PY{o}{=} \PY{n}{image2}
            \PY{n}{img}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{p}{:}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{]} \PY{o}{=} \PY{n}{image3}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{} Write your code here for tiling the six images to make a single image and displaying it. }
        ...
        \PY{n}{image1} \PY{o}{=} \PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
        \PY{n}{image2} \PY{o}{=} \PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
        \PY{n}{image3} \PY{o}{=} \PY{n}{getChannel}\PY{p}{(}\PY{n}{image}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{)}
        
        \PY{n}{resmerge1} \PY{o}{=} \PY{n}{mergeChannels}\PY{p}{(}\PY{n}{image1}\PY{p}{,} \PY{n}{image2}\PY{p}{,} \PY{n}{image3}\PY{p}{)}
        \PY{n}{resmerge2} \PY{o}{=} \PY{n}{mergeChannels}\PY{p}{(}\PY{n}{image3}\PY{p}{,} \PY{n}{image2}\PY{p}{,} \PY{n}{image1}\PY{p}{)}
        
        \PY{n}{image1} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{expand\PYZus{}dims}\PY{p}{(}\PY{n}{image1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)} \PY{o}{*} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}
        \PY{n}{image2} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{expand\PYZus{}dims}\PY{p}{(}\PY{n}{image2}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)} \PY{o}{*} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}
        \PY{n}{image3} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{expand\PYZus{}dims}\PY{p}{(}\PY{n}{image3}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)} \PY{o}{*} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}
        
        \PY{n}{wholeImage} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{2} \PY{o}{*} \PY{l+m+mi}{512}\PY{p}{,} \PY{l+m+mi}{3}\PY{o}{*}\PY{l+m+mi}{512}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{]}\PY{p}{)}
        \PY{n}{a} \PY{o}{=} \PY{l+m+mi}{512}
        \PY{n}{wholeImage}\PY{p}{[}\PY{l+m+mi}{0} \PY{p}{:} \PY{n}{a}\PY{p}{,} \PY{l+m+mi}{0} \PY{p}{:} \PY{n}{a}\PY{p}{,} \PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{image1}
        \PY{n}{wholeImage}\PY{p}{[} \PY{l+m+mi}{0} \PY{p}{:} \PY{n}{a}\PY{p}{,} \PY{n}{a} \PY{p}{:} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{a}\PY{p}{,} \PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{image2}
        \PY{n}{wholeImage}\PY{p}{[} \PY{l+m+mi}{0} \PY{p}{:} \PY{n}{a}\PY{p}{,} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{a} \PY{p}{:} \PY{l+m+mi}{3}\PY{o}{*}\PY{n}{a}\PY{p}{,}\PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{image3}
        \PY{n}{wholeImage}\PY{p}{[}\PY{n}{a} \PY{p}{:} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{a}\PY{p}{,} \PY{l+m+mi}{0} \PY{p}{:} \PY{n}{a}\PY{p}{,} \PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{image}
        \PY{n}{wholeImage}\PY{p}{[}\PY{n}{a} \PY{p}{:} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{a}\PY{p}{,} \PY{n}{a} \PY{p}{:} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{a}\PY{p}{,} \PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{resmerge1}
        \PY{n}{wholeImage}\PY{p}{[}\PY{n}{a} \PY{p}{:} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{a}\PY{p}{,} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{a} \PY{p}{:} \PY{l+m+mi}{3}\PY{o}{*}\PY{n}{a}\PY{p}{,} \PY{p}{:}\PY{p}{]} \PY{o}{=} \PY{n}{resmerge2}
        
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{wholeImage}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}4}]:} <matplotlib.image.AxesImage at 0x118c5c050>
\end{Verbatim}
